...
export const deploySite = (data, siteId) =>
  axios.post(`${API}/sites/${siteId}/deploys`, data);

export const uploadFile = (data, filename, deployId) =>
  axios.put(`${API}/deploys/${deployId}/files${filename}`, data, {
    headers: { "Content-Type": "application/octet-stream" }
  });

export const createSite = values =>
  axios.post(`${API}/sites`, values, {
